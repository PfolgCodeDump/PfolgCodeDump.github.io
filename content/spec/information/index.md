...
- **项目类型**: 静态博客网站
- **开源地址**: <https://github.com/PfolgCodeDump/FunRadiusP> MIT
...
| **Live2D models** | [imuncle/live2d:](https://github.com/imuncle/live2d) live2d模型收集+展示，可直接用于静态网站</p> "TianyeLulu" · Commercial use authorized · [Booth Shop](https://tianyelulu.booth.pm) |
| **粒子特效** | [qtqz/natural-falling-effect:](https://github.com/qtqz/natural-falling-effect) 带来一年四季的景色，让你的网页飘落花瓣树叶下雨下雪。Make your webpage fall petals and leaves, or rain and snow.|
|   **评论系统**    |                                                        [giscus](https://giscus.app/)                                                         |
|**背景**|bg1: [#女の子 紬文德斯 - Sakei的插画 - pixiv](https://www.pixiv.net/artworks/142006973)</p>bg2: [#サマーポケッツ 無題 - miraikanai的插画 - pixiv](https://www.pixiv.net/artworks/137453472)</p>bg1-dark: [#SummerPockets 無題 - miraikanai的插画 - pixiv](https://www.pixiv.net/artworks/128453927)</p>bg2-dark: [#JK JK久岛鸥 - 色纳比的插画 - pixiv](https://www.pixiv.net/artworks/132102535)|

<!-- - **主页语句**: [Hitokoto](https://hitokoto.cn/) -->
